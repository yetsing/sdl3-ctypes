...
Document: https://wiki.libsdl.org/SDL3/CategoryHints
"""
...
SDL_HintCallback = ctypes.CFUNCTYPE(
    None, ctypes.c_void_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p
)


# bool SDL_AddHintCallback(const char *name, SDL_HintCallback callback, void *userdata);
SDL_AddHintCallback = libsdl3.SDL_AddHintCallback
SDL_AddHintCallback.argtypes = [ctypes.c_char_p, SDL_HintCallback, ctypes.c_void_p]
SDL_AddHintCallback.restype = ctypes.c_bool


# const char * SDL_GetHint(const char *name);
SDL_GetHint = libsdl3.SDL_GetHint
SDL_GetHint.argtypes = [ctypes.c_char_p]
SDL_GetHint.restype = ctypes.c_char_p


# bool SDL_GetHintBoolean(const char *name, bool default_value);
SDL_GetHintBoolean = libsdl3.SDL_GetHintBoolean
SDL_GetHintBoolean.argtypes = [ctypes.c_char_p, ctypes.c_bool]
SDL_GetHintBoolean.restype = ctypes.c_bool


# void SDL_RemoveHintCallback(const char *name,
#                          SDL_HintCallback callback,
#                          void *userdata);
SDL_RemoveHintCallback = libsdl3.SDL_RemoveHintCallback
SDL_RemoveHintCallback.argtypes = [ctypes.c_char_p, SDL_HintCallback, ctypes.c_void_p]
SDL_RemoveHintCallback.restype = None


# bool SDL_ResetHint(const char *name);
SDL_ResetHint = libsdl3.SDL_ResetHint
SDL_ResetHint.argtypes = [ctypes.c_char_p]
SDL_ResetHint.restype = ctypes.c_bool


# void SDL_ResetHints(void);
SDL_ResetHints = libsdl3.SDL_ResetHints
SDL_ResetHints.argtypes = []
SDL_ResetHints.restype = None


# bool SDL_SetHint(const char *name, const char *value);
SDL_SetHint = libsdl3.SDL_SetHint
SDL_SetHint.argtypes = [ctypes.c_char_p, ctypes.c_char_p]
SDL_SetHint.restype = ctypes.c_bool


# bool SDL_SetHintWithPriority(const char *name, const char *value, SDL_HintPriority priority);
SDL_SetHintWithPriority = libsdl3.SDL_SetHintWithPriority
SDL_SetHintWithPriority.argtypes = [ctypes.c_char_p, ctypes.c_char_p, ctypes.c_int]
SDL_SetHintWithPriority.restype = ctypes.c_bool
