...
SDL_scancode.h
Keyboard Scancodes
Document: https://wiki.libsdl.org/SDL3/CategoryScancode
"""
...
SDL_SCANCODE_SLEEP = 0x102
SDL_SCANCODE_WAKE = 0x103
SDL_SCANCODE_CHANNEL_INCREMENT = 0x104
SDL_SCANCODE_CHANNEL_DECREMENT = 0x105
SDL_SCANCODE_MEDIA_PLAY = 0x106
SDL_SCANCODE_MEDIA_PAUSE = 0x107
SDL_SCANCODE_MEDIA_RECORD = 0x108
SDL_SCANCODE_MEDIA_FAST_FORWARD = 0x109
SDL_SCANCODE_MEDIA_REWIND = 0x10A
SDL_SCANCODE_MEDIA_NEXT_TRACK = 0x10B
SDL_SCANCODE_MEDIA_PREVIOUS_TRACK = 0x10C
SDL_SCANCODE_MEDIA_STOP = 0x10D
SDL_SCANCODE_MEDIA_EJECT = 0x10E
SDL_SCANCODE_MEDIA_PLAY_PAUSE = 0x10F
SDL_SCANCODE_MEDIA_SELECT = 0x110
SDL_SCANCODE_AC_NEW = 0x111
SDL_SCANCODE_AC_OPEN = 0x112
SDL_SCANCODE_AC_CLOSE = 0x113
SDL_SCANCODE_AC_EXIT = 0x114
SDL_SCANCODE_AC_SAVE = 0x115
SDL_SCANCODE_AC_PRINT = 0x116
SDL_SCANCODE_AC_PROPERTIES = 0x117
SDL_SCANCODE_AC_SEARCH = 0x118
SDL_SCANCODE_AC_HOME = 0x119
SDL_SCANCODE_AC_BACK = 0x11A
SDL_SCANCODE_AC_FORWARD = 0x11B
SDL_SCANCODE_AC_STOP = 0x11C
SDL_SCANCODE_AC_REFRESH = 0x11D
SDL_SCANCODE_AC_BOOKMARKS = 0x11E
SDL_SCANCODE_SOFTLEFT = 0x11F
SDL_SCANCODE_SOFTRIGHT = 0x120
SDL_SCANCODE_CALL = 0x121
SDL_SCANCODE_ENDCALL = 0x122
SDL_SCANCODE_RESERVED = 0x190
SDL_SCANCODE_COUNT = 0x200
